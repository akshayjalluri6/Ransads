  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-100 to-white dark:from-black dark:via-blue-950 dark:to-sky-900 flex flex-col items-center justify-start py-16 px-4">
      <div className="max-w-3xl w-full text-center mb-12">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold gradient-text mb-4">Fleet Management</h1>
        <p className="text-lg md:text-xl text-gray-700 dark:text-sky-100 mb-6">Join our trusted network of truck owners and maximize your earning potential with RansAds.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl w-full mb-12">
        <Card className="glass-effect p-8 flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 dark:text-sky-100">Sign up and start earning with minimal paperwork and fast approval.</p>
        </Card>
        <Card className="glass-effect p-8 flex flex-col items-center text-center">
          <CheckCircle className="w-8 h-8 text-sky-500 mb-2" />
          <h3 className="text-xl font-bold mb-2">Guaranteed Payments</h3>
          <p className="text-gray-600 dark:text-sky-100">Get paid on time, every month, with transparent earnings tracking.</p>
        </Card>
        <Card className="glass-effect p-8 flex flex-col items-center text-center">
          <CheckCircle className="w-8 h-8 text-sky-500 mb-2" />
          <h3 className="text-xl font-bold mb-2">24/7 Support</h3>
          <p className="text-gray-600 dark:text-sky-100">Our team is always available to help with any questions or issues.</p>
        </Card>
        <Card className="glass-effect p-8 flex flex-col items-center text-center">
          <CheckCircle className="w-8 h-8 text-sky-500 mb-2" />
          <h3 className="text-xl font-bold mb-2">Exclusive Benefits</h3>
          <p className="text-gray-600 dark:text-sky-100">Access insurance, maintenance, and rewards as a RansAds partner.</p>
        </Card>
      </div>
